...
-- Función para clasificar un punto de prueba utilizando el clasificador 1NN
function oneNNClassifier(trainingSet, labels, testPoint)
...
-- Clasificar el punto de prueba utilizando el clasificador 1NN
local result = oneNNClassifier(trainingSet, labels, testPoint)
